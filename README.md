...
Criação de carrossel com Bootstrap 
 ...
 Smooth-scroll No Bootstrap refere-se a uma funcionalidade de rolagem suave ou animada que pode ser aplicada a links internos de uma página. Em vez de uma transição de rolagem instantânea, a rolagem suave cria um efeito visual mais agradável à medida que o usuário navega pela página.
